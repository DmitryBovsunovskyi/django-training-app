...
urlpatterns = [
    ...
    path('update/', views.ManageUserView.as_view(), name="logout"),
    ...
    path('password-reset-complete/<uidb64>/<token>/', views.SetNewPasswordView.as_view(), name='password-reset-complete')
]
